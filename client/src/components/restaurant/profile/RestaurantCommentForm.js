...
function RestaurantCommentForm() {

    const [open, setOpen] = React.useState(false);

    // -------------initial states for fields---------------------------
    const initialValues = { commentDescription: "" };
    ...
    return (
        ...
        <Box sx={{
            ...
            >
                <DialogTitle>{"Add Restaurant Comment"}</DialogTitle>
                <DialogContent>
                    <Box component="form"
                        noValidate
                        autoComplete="off">
...
export default RestaurantCommentForm